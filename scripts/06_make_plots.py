...
SUMMARY_PATH = DATA_DIR / "theorem_summary.csv"
STRATEGY_PATH = DATA_DIR / "strategy_reliability.csv"
PROOFS_PATH = DATA_DIR / "annotated_proof_attempts.csv"
...
def plot_entropy_by_theorem():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR / "entropy_by_theorem.png", dpi=300)
    plt.close()
...
def plot_entropy_vs_correctness():
    ...
    plt.title("Entropy vs. Correctness Rate")
    plt.ylim(-0.05, 1.05)
    plt.tight_layout()
    plt.savefig(FIG_DIR / "entropy_vs_correctness.png", dpi=300)
    plt.close()
...
def plot_strategy_reliability():
    ...
    plt.title("Bayesian Reliability Estimate by Strategy")
    plt.xticks(rotation=45, ha="right")
    plt.ylim(0, 1.05)
    plt.tight_layout()
    plt.savefig(FIG_DIR / "strategy_reliability.png", dpi=300)
    plt.close()
...
def plot_error_types():
    ...
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    plt.savefig(FIG_DIR / "error_types.png", dpi=300)
    plt.close()
...
def main():
    ...
    print("Saved figures:")
    print(FIG_DIR / "entropy_by_theorem.png")
    print(FIG_DIR / "entropy_vs_correctness.png")
    print(FIG_DIR / "strategy_reliability.png")
    print(FIG_DIR / "error_types.png")
